...
public interface Profiles {
	...
	/**
	 * Obtains the list of users the given user is following.
	 * 
	 * @param userId of the user
	 * @return (OK, List<UserId>|empty list) or NOT_FOUND if the user profile is not known
	 */
	Result<List<String>> followingList(String userId);
}
